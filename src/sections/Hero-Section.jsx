...
import Curious from '../components/Curious'; // Imported separate popup component
...
export default function HeroSection() {
  ...
  const [showHandsomeModal, setShowHandsomeModal] = useState(false);
    ...
    <section className="relative overflow-hidden rounded-[40px] border border-gray-200 dark:border-white/10 bg-white dark:bg-zinc-950/40 p-8 md:p-14 shadow-xl transition-all duration-300">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center lg:items-start xl:items-center gap-10 xl:gap-14">
        ...
        <div className="relative shrink-0">
          ...
          <div 
            className="relative cursor-pointer group cursor-target sfx-mini"
            onMouseEnter={() => setIsHovered(true)}
            onMouseLeave={() => setIsHovered(false)}
            onClick={() => setShowHandsomeModal(true)}
          ...
          >
            ...
            <div className="absolute bottom-3 right-3 lg:bottom-6 lg:right-6 w-5 h-5 bg-emerald-500 border-4 border-white dark:border-zinc-950 rounded-full shadow-md z-30 animate-pulse"></div>
          </div>
        </div>

        {/* RIGHT COLUMN: Casual Content */}
        <div className="text-center lg:text-left space-y-5 flex-1 w-full max-w-2xl">
            ...
            <div className="flex items-center gap-3.5">
              ...
              <div className="relative group/tooltip flex items-center justify-center">
                <button 
                  ...
                  className={`cursor-target transition-colors p-0.5 rounded ${showEmails ? 'text-blue-500' : 'text-gray-500 dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-400'}`}
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center justify-center lg:justify-start gap-2 h-10">
              <Code2 size={20} className="text-blue-500 shrink-0 hidden md:block" />
              <img 
          ...
          {/* Intro Blending 'Hello' + CTU Student Bio */}
          <p className="text-base text-gray-600 dark:text-gray-300 font-medium leading-relaxed">
            Hello! I'm a simple CTU student who literally codes for food. I mostly spend my time messing around with <span className="text-gray-900 dark:text-white font-bold">UI/UX prototyping</span>, building clean <span className="text-gray-900 dark:text-white font-bold">frontend interfaces</span>, and mapping out <span className="text-gray-900 dark:text-white font-bold">system architectures and flows</span> — constantly exploring AI tools and desktop automation along the way.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3.5 pt-2">
            ...
            >
              <FolderCode size={16} /> Check My Work
      ...
      {/* --- CURIOUS POPUP MODAL --- */}
      <Curious 
        isOpen={showHandsomeModal} 
        onClose={() => setShowHandsomeModal(false)} 
      />
    </section>
  );
}