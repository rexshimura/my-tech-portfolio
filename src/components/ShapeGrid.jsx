...
const ShapeGrid = ({
  direction = 'diagonal',
  speed = 0.5,
  borderColor = 'rgba(153, 153, 153, 0.15)', // Tweaked for clean background visibility
  squareSize = 50, // Slightly increased size for large 1440px displays
  hoverFillColor = 'rgba(59, 130, 246, 0.08)', // Interactive brand blue overlay tint
  shape = 'square',
  hoverTrailAmount = 6
}) => {
  ...
  useEffect(() => {
    ...
    const drawGrid = () => {
      ...
      // REMOVED THE STATIC DARK RADIAL GRADIENT OVERLAY
      // This allows Tailwind background classes inside App.jsx to handle dark/light transitions smoothly.
    };
